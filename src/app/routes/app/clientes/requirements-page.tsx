  ...
  return (
    <>
      ...
      <div className="p-4 md:p-6">
        ...
        <DocumentListModal
          open={
            viewDocsItem !== null && selectedVehicleForDocs !== null && viewSubitemDocs === null
          }
          itemName={viewDocsItem?.name || ''}
          documents={
        ...
        <DocumentFormModal
          ...
          itemName={
            documentModalSubitem ? documentModalSubitem.name : documentModalItem?.name || ''
          }
